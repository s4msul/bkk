...
function message_custom(tipe, judul, pesan, focus){
	 $.pnotify({
            title: judul,
            text: pesan,
            type: tipe,
...
function access_failed(status){
    var pesan = 'Gagal akses data';
    var tipe = 'error';
    if (status === 404) {
        pesan = 'Data yang anda minta tidak ada';
        tipe = 'info';
    }
