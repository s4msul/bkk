				...
				<div id="primary" class="sidebar-right">
				    <div class="inner group">
				        ...
				        <div id="content-blog" class="content group">
				            <?php foreach ($list_lowongan as $data) { ?>
				            <div class="hentry hentry-post blog-small group ">
				                <!-- post featured & title -->
				                <div class="thumbnail">
				                    <!-- post title -->
                                                    <h2 class="post-title"><a href="<?= base_url('main/jobvacancydetail/'.$data->id) ?>"><?= $data->nama ?></a></h2>
				                    <!-- post meta -->
				                    <div class="meta group">
                                                        <p class="date">TANGGAL POSTING <?= (datetimefmysql($data->tanggal)) ?> // Lowongan Berlaku sampai <?= indo_tgl($data->berlaku) ?></p>
...
<!--				                        <p class="categories"><span>In: <a href="#" title="View all posts in Happyness" rel="category tag">Happyness</a>, <a href="#" title="View all posts in Romantic Vintage" rel="category tag">Romantic Vintage</a></span></p>
				                    ...
				                    <div class="image-wrap">
                                                        <img src="<?= base_url('assets/images/articles/'.$data->logo) ?>" style="width: 205px; height: 185px;" />        
				                    </div>
				                </div>
				                <!-- post content -->
				                <div class="the-content group">
				                    <?= substr(strip_tags($data->isi),0,550) ?> [...]
				                    <p><a href="<?= base_url('main/jobvacancydetail/'.$data->id) ?>" class="btn   btn-beetle-bus-goes-jamba-juice-4 btn-more-link">→ Read more</a></p>
				                </div>
				            </div>
                                            <?php } ?>
