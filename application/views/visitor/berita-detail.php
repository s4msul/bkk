				            ...
				            <div class="hentry hentry-post blog-big group ">
				                ...
				                <div class="thumbnail">
				                    ...
				                    <div class="image-wrap">
                                                        <img src="<?= base_url('assets/images/projects/'.$data->gambar) ?>" alt="00212" title="00212" style="width: 816px;" />        
				                    </div>
				                    <p class="date">
                                                        <span class="month"><?= substr(tampil_bulan($data->tanggal),0,3) ?></span>
                                                        <span class="day"><?= substr($data->tanggal, 8,2) ?></span>
				                    </p>
				                </div>
				                <!-- post meta -->
				                <div class="meta group">
				                    <p class="author"><span>by Administrator</span></p>
				                    <p class="categories"><span>In: E-learning, Job Vacancy</span></p>
				                    <p class="comments"><span>comments are disabled</span></p>
				                </div>
				                <!-- post content -->
